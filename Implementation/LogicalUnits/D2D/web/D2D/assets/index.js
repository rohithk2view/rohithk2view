...
async function batchRunningStatus(command) {
  try {
    const response = await fetch(`/api/fabric-command?command=${command}`);
    const result = await response.json();
    const mappedResult = Array.isArray(result) ? result.map((item) => ({
      id: item["Id"],
      executionId: item["Execution id"],
      status: item["Status"],
      endDate: item["End date"]
    })) : [];
    const batchRunning = mappedResult.some((item) => item.status === "IN_PROGRESS");
    return {
      result: mappedResult,
      batchRunning,
      error: null
...
function D2DForm({
  ...
  return /* @__PURE__ */ jsxs("form", {
    ...
    children: [/* @__PURE__ */ jsx("h1", {
      ...
      children: [/* @__PURE__ */ jsxs("div", {
      ...
      }), /* @__PURE__ */ jsx("div", {}), (params.d2dMode === "tdm_extract" || params.d2dMode === "tdm_direct") && /* @__PURE__ */ jsxs("div", {
      ...
      }), (params.d2dMode === "fabric_to_fabric" || params.d2dMode === "table_to_table" || params.d2dMode === "table_level") && /* @__PURE__ */ jsxs("div", {
        children: [/* @__PURE__ */ jsxs("label", {
          className: "text-gray-700",
          ...
          name: "D2D_INTERFACE_SRC",
          value: params.D2D_INTERFACE_SRC,
          onChange: handleInputChange,
          className: "w-full mt-1 p-2 border rounded",
          required: true,
          children: [/* @__PURE__ */ jsx("option", {
            children: "Select source interface"
          }), params.d2dMode !== "table_to_table" && /* @__PURE__ */ jsx("option", {
            value: "fabric",
            children: "fabric"
          ...
          }) : interfaceData.filter((item) => {
            if (params.d2dMode === "fabric_to_fabric" || params.d2dMode === "table_level") {
              const type = item.TYPE;
              return type.toLowerCase() === "fabric (db)" || type.toLowerCase() === "remotefabricd2d (db)";
            }
            if (params.d2dMode === "table_to_table") {
              const type = item.TYPE;
              return type.toLowerCase() === "cassandra (db)" || type.toLowerCase() === "postgresql (db)";
            }
            return true;
          }).map((item) => /* @__PURE__ */ jsx("option", {
        ...
        children: [/* @__PURE__ */ jsxs("label", {
          ...
          name: "D2D_INTERFACE_TAR",
          value: params.D2D_INTERFACE_TAR,
          onChange: handleInputChange,
          className: "w-full mt-1 p-2 border rounded",
          required: true,
          children: [/* @__PURE__ */ jsx("option", {
      ...
      }), (params.d2dMode === "fabric_to_fabric" || params.d2dMode === "table_level" || params.d2dMode === "table_to_table") && /* @__PURE__ */ jsxs("div", {
        children: [/* @__PURE__ */ jsxs("label", {
          className: "text-gray-700",
        ...
        children: [/* @__PURE__ */ jsxs("label", {
          ...
          type: "text",
          name: "D2D_SCHEMA_TAR",
          value: params.D2D_SCHEMA_TAR,
          onChange: handleInputChange,
          className: "w-full mt-1 p-2 border rounded",
          required: true
        })]
      }), params.d2dMode === "table_to_table" && /* @__PURE__ */ jsxs("div", {
        children: [/* @__PURE__ */ jsxs("label", {
          className: "text-gray-700",
          children: ["Source table", /* @__PURE__ */ jsx("span", {
            className: "text-red-500 ml-1",
            children: "*"
          })]
        }), /* @__PURE__ */ jsxs("select", {
          name: "D2D_LKP_TABLE_SRC",
          value: params.D2D_LKP_TABLE_SRC,
          onChange: handleInputChange,
          className: "w-full mt-1 p-2 border rounded",
          required: true,
          children: [/* @__PURE__ */ jsx("option", {
          ...
          }), srcTableLoading ? /* @__PURE__ */ jsx("option", {
            children: "Loading..."
          }) : srcTableError ? /* @__PURE__ */ jsx("option", {
            children: "Error loading Tables"
          }) : [...new Set(srcTableData.map((item) => item.Source_Table_Name))].map((sourceTable, index2) => /* @__PURE__ */ jsx("option", {
            value: sourceTable,
        ...
        children: [/* @__PURE__ */ jsxs("label", {
          className: "text-gray-700",
          children: ["Target table", /* @__PURE__ */ jsx("span", {
            className: "text-red-500 ml-1",
            children: "*"
          })]
        }), /* @__PURE__ */ jsx("select", {
          name: "D2D_LKP_TABLE_TAR",
          value: params.D2D_LKP_TABLE_TAR,
          onChange: handleInputChange,
          className: "w-full mt-1 p-2 border rounded",
          required: true,
          children: srcTableLoading ? /* @__PURE__ */ jsx("option", {
            children: "Loading..."
          }) : srcTableError ? /* @__PURE__ */ jsx("option", {
            children: "Error loading Tables"
          }) : params.D2D_LKP_TABLE_SRC && params.D2D_LKP_TABLE_SRC.trim() !== "" ? /* @__PURE__ */ jsxs(Fragment, {
            children: [/* @__PURE__ */ jsx("option", {
              disabled: true,
              value: "",
              children: "Select target table"
            }), [...new Set(srcTableData.filter((item) => item.Source_Table_Name === params.D2D_LKP_TABLE_SRC.trim()).map((item) => item.Target_Table_Name))].map((targetTable, index2) => /* @__PURE__ */ jsx("option", {
              value: targetTable,
            ...
            disabled: true,
            value: "",
            children: "Select source table first"
          })
        })]
        ...
        children: [/* @__PURE__ */ jsxs("label", {
          className: "text-gray-700",
          children: ["Lookup keys table interface", /* @__PURE__ */ jsx("span", {
            className: "text-red-500 ml-1",
            children: "*"
          })]
        }), /* @__PURE__ */ jsxs("select", {
          name: "D2D_LKP_KEYS_TABLE_INTERFACE",
          value: params.D2D_LKP_KEYS_TABLE_INTERFACE,
          onChange: handleInputChange,
          className: "w-full mt-1 p-2 border rounded",
          required: true,
          children: [/* @__PURE__ */ jsx("option", {
        ...
        children: [/* @__PURE__ */ jsxs("label", {
          className: "text-gray-700",
          children: ["Lookup keys table schema", /* @__PURE__ */ jsx("span", {
            className: "text-red-500 ml-1",
            children: "*"
          })]
        }), /* @__PURE__ */ jsx("input", {
          type: "text",
          name: "D2D_LKP_KEYS_TABLE_SCHEMA",
          value: params.D2D_LKP_KEYS_TABLE_SCHEMA,
          onChange: handleInputChange,
          className: "w-full mt-1 p-2 border rounded",
          required: true
        })]
        ...
        children: [/* @__PURE__ */ jsxs("label", {
          className: "text-gray-700",
          children: ["Lookup keys table", /* @__PURE__ */ jsx("span", {
            className: "text-red-500 ml-1",
            children: "*"
          })]
        }), /* @__PURE__ */ jsx("input", {
          type: "text",
          name: "D2D_LKP_KEYS_TABLE_NAME",
          value: params.D2D_LKP_KEYS_TABLE_NAME,
          onChange: handleInputChange,
          className: "w-full mt-1 p-2 border rounded",
          required: true
        })]
      }), (params.d2dMode === "tdm_direct" || params.d2dMode === "tdm_extract" || params.d2dMode === "table_to_table") && /* @__PURE__ */ jsx("div", {}), /* @__PURE__ */ jsx("div", {
        children: /* @__PURE__ */ jsxs("label", {
      ...
      children: [/* @__PURE__ */ jsx("button", {
        ...
        type: "button",
        disabled: runStatus,
        className: `py-2 px-4 rounded-lg ${runStatus ? "bg-gray-400 text-white cursor-not-allowed" : "bg-gray-500 text-white py-2 px-4 rounded-lg hover:bg-gray-600"}`,
        onClick: handleReset,
        children: "Reset"
      })]
    })]
...
function ExecutionResults({
  ...
  const errorMessage = localStorage.getItem("D2D_EXEC_ERROR") || "";
    ...
    if (sortConfig.key) {
      sorted.sort((a, b) => {
        ...
        if (sortConfig.key === "status") {
          ...
          const dateA2 = a.endDate ? new Date(a.endDate) : null;
          const dateB2 = b.endDate ? new Date(b.endDate) : null;
          if (!dateA2 && !dateB2) return 0;
          if (!dateA2) return sortConfig.direction === "asc" ? 1 : -1;
          if (!dateB2) return sortConfig.direction === "asc" ? -1 : 1;
          primaryComparison = sortConfig.direction === "asc" ? dateA2 - dateB2 : dateB2 - dateA2;
        } else {
          const valA = a[sortConfig.key];
          const valB = b[sortConfig.key];
          if (valA < valB) primaryComparison = -1;
          else if (valA > valB) primaryComparison = 1;
          if (sortConfig.direction === "desc") primaryComparison *= -1;
        }
  ...
  return /* @__PURE__ */ jsxs("div", {
    className: "w-full max-w-4xl bg-white shadow-lg rounded-lg p-6 mt-6",
      ...
      children: /* @__PURE__ */ jsxs("table", {
        ...
        children: [/* @__PURE__ */ jsx("thead", {
          children: /* @__PURE__ */ jsx("tr", {
            className: "bg-red-100 text-left",
            children: /* @__PURE__ */ jsx("th", {
              className: "p-2 border-b text-sm font-medium text-red-700",
              children: "Exception"
            })
          })
        }), /* @__PURE__ */ jsx("tbody", {
          children: /* @__PURE__ */ jsx("tr", {
            ...
            children: /* @__PURE__ */ jsx("td", {
              className: "p-2 border-b text-sm text-red-700",
              children: errorMessage
            })
          })
        })]
      })
    }) : batchResult.length === 0 ? /* @__PURE__ */ jsx("p", {
      className: "text-gray-500",
      children: "No active D2D batch executions."
    }) : /* @__PURE__ */ jsx("div", {
      className: "overflow-x-auto",
      children: /* @__PURE__ */ jsxs("table", {
        className: "w-full table-auto border-collapse",
        children: [/* @__PURE__ */ jsx("thead", {
          children: /* @__PURE__ */ jsxs("tr", {
            ...
            children: [/* @__PURE__ */ jsx("th", {
              ...
              className: "p-2 border-b text-sm font-medium text-gray-600 cursor-pointer",
              onClick: () => handleSort("status"),
              children: ["Status ", sortConfig.key === "status" ? sortConfig.direction === "asc" ? "▲" : "▼" : ""]
            }), /* @__PURE__ */ jsxs("th", {
              className: "p-2 border-b text-sm font-medium text-gray-600 cursor-pointer",
              onClick: () => handleSort("endDate"),
              children: ["End Date ", sortConfig.key === "endDate" ? sortConfig.direction === "asc" ? "▲" : "▼" : ""]
            })]
          })
        }), /* @__PURE__ */ jsx("tbody", {
          children: sortedResults.map((item, index2) => /* @__PURE__ */ jsxs("tr", {
            ...
            children: [/* @__PURE__ */ jsx("td", {
              ...
              className: "p-2 border-b text-sm text-gray-700",
              children: item.executionId
            }), /* @__PURE__ */ jsx("td", {
              className: `p-2 border-b text-sm font-medium ${item.status === "NEW" ? "text-indigo-600" : item.status === "GENERATE_IID_LIST" ? "text-purple-600" : item.status === "IN_PROGRESS" ? "text-blue-600" : item.status === "FAILED" ? "text-red-600" : item.status === "CANCELLED" ? "text-orange-600" : item.status === "DONE" ? "text-green-600" : "text-black"}`,
...
function D2DProcessUI() {
  const defaultParams = {
    ...
    D2D_SCHEMA_TAR: "",
    EXECUTION_ID: "",
    D2D_LKP_KEYS_TABLE_INTERFACE: "",
    D2D_LKP_KEYS_TABLE_SCHEMA: "",
    D2D_LKP_KEYS_TABLE_NAME: "",
    D2D_LKP_TABLE_SRC: "",
    D2D_LKP_TABLE_TAR: "",
  ...
  const [srcTableData, setSrcTableData] = reactExports.useState(false);
  const [runStatus, setRunStatus] = reactExports.useState(false);
  const [batchResult, setBatchResult] = reactExports.useState([]);
  const [execError, setExecError] = reactExports.useState(localStorage.getItem("D2D_EXEC_ERROR") !== "");
  const {
    fetchData: fetchSrcTableData,
    loading: srcTableLoading,
    error: srcTableError
  } = useFetchData("/api/fabric-command?command=broadway%20D2D.bwLookupTableNames%20RESULT_STRUCTURE=CURSOR");
  const {
  ...
  const {
    fetchData: fetchBatchSet
  } = useFetchData("/api/fabric-command?command=set%20D2D.D2D_EXEC_ID%3B");
  const {
    data: schemaSrcData
  } = useFetchData(params.D2D_FABRIC_INTERFACE_SRC ? `/api/d2d/get-schema?interfaceName=${encodeURIComponent(params.D2D_INTERFACE_SRC)}` : null);
  reactExports.useEffect(() => {
    (async () => {
      setSrcTableData(await fetchSrcTableData());
    })();
  }, [fetchSrcTableData]);
  const {
    data: schemaTarData
  } = useFetchData(params.D2D_FABRIC_INTERFACE_TAR ? `/api/d2d/get-schema?interfaceName=${encodeURIComponent(params.D2D_INTERFACE_TAR)}` : null);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    (async () => {
      setInterfaceData(await fetchInterfaceData());
    })();
  }, [fetchInterfaceData]);
  reactExports.useEffect(() => {
    (async () => {
      setEnvironmentData(await fetchEnvironmentData());
    })();
  }, [fetchEnvironmentData]);
  reactExports.useEffect(() => {
    (async () => {
      setLuData(await fetchLuData());
    })();
  }, [fetchLuData]);
  reactExports.useEffect(() => {
    if (schemaSrcData) setParams((prev) => ({
      ...prev,
      D2D_F2F_SCHEMA_SRC: schemaSrcData
    }));
  }, [schemaSrcData]);
  reactExports.useEffect(() => {
    if (schemaTarData) setParams((prev) => ({
      ...prev,
  ...
  }, [params.D2D_LKP_TABLE_SRC]);
  reactExports.useEffect(() => {
    localStorage.setItem("d2dProcessParams", JSON.stringify(params));
  }, [params]);
  reactExports.useEffect(() => {
    const fetchAndUpdate = async () => {
      if (localStorage.getItem("D2D_EXEC_ERROR") !== "") return;
      try {
        const executionResponse = await fetchBatchSet();
        const executionId = Array.isArray(executionResponse) && executionResponse.length > 0 ? executionResponse[0].value : null;
        if (!executionId) return;
        const command = encodeURIComponent(`batch_list FILTER ='${executionId}' status ='ALL'`);
        const {
          result,
          batchRunning
        } = await batchRunningStatus(command);
    ...
    fetchAndUpdate();
    const intervalId = setInterval(fetchAndUpdate, 2e3);
  ...
  const handleExecution = async () => {
    console.log("Parameters selected:", params);
    let commandsArray = [];
    let luType = "D2D";
    ...
    if (params.EXECUTION_ID.trim() !== "") {
      commandsArray.push(`set EXECUTION_ID="${params.EXECUTION_ID}";`);
    }
    ...
    if (params.d2dMode === "fabric_to_fabric" || params.d2dMode === "table_level") {
      commandsArray.push(`set D2D_FABRIC_INTERFACE_SRC = "${params.D2D_INTERFACE_SRC}";`);
      commandsArray.push(`set D2D_FABRIC_INTERFACE_TAR = "${params.D2D_INTERFACE_TAR}";`);
    }
    if (params.d2dMode === "table_level" || params.d2dMode === "fabric_to_fabric") {
      commandsArray.push(`set D2D_F2F_SCHEMA_SRC = "${params.D2D_SCHEMA_SRC}";`);
      commandsArray.push(`set D2D_F2F_SCHEMA_TAR = "${params.D2D_SCHEMA_TAR}";`);
    }
    if (params.d2dMode === "table_to_table") {
      commandsArray.push(`set D2D_LKP_INTERFACE_SRC = "${params.D2D_INTERFACE_SRC}";`);
      commandsArray.push(`set D2D_LKP_INTERFACE_TAR = "${params.D2D_INTERFACE_TAR}";`);
      commandsArray.push(`set D2D_LKP_SCHEMA_SRC = "${params.D2D_SCHEMA_SRC}";`);
      commandsArray.push(`set D2D_LKP_SCHEMA_TAR = "${params.D2D_SCHEMA_TAR}";`);
      commandsArray.push(`set D2D_LKP_KEYS_TABLE_INTERFACE = "${params.D2D_LKP_KEYS_TABLE_INTERFACE}";`);
      commandsArray.push(`set D2D_LKP_KEYS_TABLE_SCHEMA = "${params.D2D_LKP_KEYS_TABLE_SCHEMA}";`);
      commandsArray.push(`set D2D_LKP_KEYS_TABLE_NAME = "${params.D2D_LKP_KEYS_TABLE_NAME}";`);
      commandsArray.push(`set D2D_LKP_TABLE_SRC = "${params.D2D_LKP_TABLE_SRC}";`);
      commandsArray.push(`set D2D_LKP_TABLE_TAR = "${params.D2D_LKP_TABLE_TAR}";`);
    }
    ...
    if (params.d2dMode !== "table_to_table") {
      if (params.executionMode === "single") {
        ...
        bwCommand += ` interface="${params.batchInterface}" sql="${params.batchSql.trim().replace(/;$/, "")}";`;
      }
    }
    ...
    console.log("Final list of commands:", commands);
    try {
      setExecError(false);
      localStorage.setItem("D2D_EXEC_ERROR", "");
      setRunStatus(true);
      const res = await fetch(`/api/fabric-command?command=${encoded}&allResultSets=false`);
      const result = await res.json();
      if (!res.ok) {
        const errorText = `Fetch failed: ${res.status} ${JSON.stringify(result)}`;
        setExecError(true);
        localStorage.setItem("D2D_EXEC_ERROR", errorText);
        throw new Error(errorText);
      }
      setBatchResult(result.schemas || result);
      setRunStatus(true);
    } catch (err) {
